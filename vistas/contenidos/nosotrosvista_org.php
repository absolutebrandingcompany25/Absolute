  ...
  <div class="banner-caption">
    <div class="container">
     <div class="row " style="margin-top: 0px;">
        ...
        <div class="col-sm-6">
    <img src="vistas/assets/images/absolute_branding_blanco.png" class="imgcreative">
        </div>
...
<section class="section clearfix no-view secPadding" data-animation-effect="fadeIn" style="padding-top: 130px;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
