...
<div id="banner" class="banner bannerP">
  ...
  <div class="banner-caption">
    <div class="container">
      <div class="row ">
        <div class="col-sm-12">
          <img src="vistas/assets/images/contacto_blanco_grande.png" class="img_responsive" style="margin: auto;" alt="contacto">
        </div>
...
<section class="hero-caption secPaddingcuadro1 quees">
  <div class="container gris parah1" style="width: 100%">
    <div class="row ">
      <div class="col-sm-12">
        <h1 class="grande">Diseño web, agencia de publicidad y marketing digital</h1>
      </div>
...
<section class="hero-caption secPaddingcuadro1" style="padding: 0;" id="resultado">
  <div class="col-sm-6 planb hola" style="background-color: #ed1a3b;box-shadow: #000000a6 11px 0px 13px 3px!important;padding-right:0px;">
    <h2 class="enormecontacto">¡Dinos hola!<br />
      <i class="fa fa-whatsapp" style="color:#ffffff;"></i> <a href="https://wa.me/+34986905000?text=Hola" style="color:#ffffff;">986 905000</a>
  </div>
  <div class="col-sm-6 fotofondo" style="background-color: white;height:485px;box-shadow: #000000a6 11px 0px 13px 3px!important;padding:0px; background-repeat: no-repeat;background-size: cover !important;background: url('vistas/assets/images/contacto.jpg');background-position: center;" title="Contacta con nosotros">
    ...
    <div class="row ">
      ...
      <div class="col-sm-7">
        ...
        if ($resultado != '') {
          ...
          echo "<!-- Event snippet for Consulta Stands conversion page -->
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-408346955/jCAqCMvnvK4DEMvC28IB',
      'value': 25.0,
      'currency': 'EUR'
  });
</script>";
        ...
        ?>
          ...
          <form role="form" id="footer-form" action="/mail.php" method="post">
            ...
            <p class="legal_movil">
              La comunicación enviada quedará incorporada a un fichero del que es responsable Absolute Branding Company, SL. Esta comunicación se utilizará exclusivamente para tratar sus datos para atender su solicitud, siempre de acuerdo al Reglamento (UE) 2016/679 (RGPD), la Ley Orgánica 15/1999 (LOPD) y el Real Decreto 1720/2007 de desarrollo de la LOPD), sobre protección de datos.Tus datos no se comunicaran a terceros, excepto por obligación legal, y se mantendrán mientras no solicite su cancelación. En cualquier momento usted puede ejercer los derechos de acceso, rectificación, portabilidad y oposición, o si procede, a la limitación y/o cancelación del tratamiento, comunicándolo por escrito, indicando sus datos personales a Paseo de la Castellena, 123 28046 Madrid o mediante un email a lopd@absolutebrandingcompany.com
            </p>
          ...
          <script>
            $('#footer-form').submit(function(event) {
              ...
              grecaptcha.ready(function() {
                grecaptcha.execute('6Ld9GhkaAAAAALtdcJqqWcTWMUgQEiYEceQvt0N7', {
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        <p style="font-size:14px;">
          ...
          <i class="fa fa-phone" aria-hidden="true"></i> 986 905000
        </p>
...
<section class="hero-caption secPaddingcuadro5 quees" id="ayudamos">
  <div class="container" style="width: 95% !important;">
    <div class="row">
      ...
      <div class="col-sm-7 padcero">
        <p style="text-align: justify;padding-top: 45px;font-size:14px; padding-bottom:0px !important;">
