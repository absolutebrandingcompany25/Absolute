  ...
  <div class="container gris parah1sv" style="width: 100%">
    <div class="row " style="margin-top: 0px;">
      <div class="col-sm-12 creativeM" style="margin-top: 0%">
        <h1 class="grande">Contratación de logística para eventos</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 conten" style="padding:0px !important">
        <div class="col-md-6 altocompleto col-xs-12 imagen two textosvc">
          <div class="texto">
            <h2>Logística integral para eventos</h2>
            <p>
              Proporcionamos soluciones logísticas de alta calidad durante la preparación del lugar y el día del evento, lo que garantizará su buen funcionamiento. Cuidamos con atención todos los detalles y respondemos adecuadamente a las posibles incidencias para que el evento fluya con naturalidad. Elaboramos e implementamos el adecuado Plan Logístico, realizando la planificación y control integrados del transporte de mercancías, alimentos, equipos y personas en toda Europa para que lleguen al lugar del evento a tiempo y del modo más eficiente y rentable.
            <div style="text-align: center;" class="salto">
              <ul style="text-align:left;display:inline-block;">
                <li>Logística del Emplazamiento</li>
                <li>Almacenaje y Distribución</li>
                <li>Gestión de Entregas y Horarios de Carga/Descarga</li>
                <li>Transporte</li>
                <li>Seguimiento de Activos</li>
                <li>Logística de Salida</li>
              </ul>
            </div>
            </p>
          </div>
        ...
        <div id="myCarousel" class="carousel slide col-md-6 one" data-ride="carousel">
          <div class="carousel-inner slidesvs" role="listbox">
            <div class="item" style="background: url('vistas/assets/images/logistica/hgg.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/logistica/7.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/logistica/jhfe.jpg');">
            </div>
            <div class="item active" style="background: url('vistas/assets/images/logistica/jhg.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/logistica/oktt.jpg');">
            </div>
          </div>
