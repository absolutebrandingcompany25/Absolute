  ...
  <div class="container gris parah1sv" style="width: 100%">
    <div class="row " style="margin-top: 0px;">
      <div class="col-sm-12 creativeM" style="margin-top: 0%">
        <h1 class="grande">Agencia de azafatas y promotoras</h1>
      </div>
      ...
      <div class="col-md-12 conten" style="padding:0px !important">
          ...
          <div class="texto">
            ...
            <div style="text-align: center;" class="salto">
              ...
              <!--p>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a class="linkVideoYT" href="https://www.youtube.com/watch?v=bGcnWPvmeWM" target="_blank">Video de YouTube</a>
                </p>
                ...
                <p>
                    ...
                    <img src="vistas/assets/images/yti.png" alt="Logo YouTube" class="yti">
                    &nbsp;&nbsp;&nbsp;
                    <a class="linkVideoYT" href="https://www.youtube.com/watch?v=PUVH1tiswPY" target="_blank">Video de YouTube</a>
                </p!-->
            </div>
            </p>
          </div>
        ...
        <div id="myCarousel" class="carousel slide col-md-6 one" data-ride="carousel">
          <div class="carousel-inner slidesvs" role="listbox">
            <div class="item active" style="background: url('vistas/assets/images/azafatas/nuevas1023/1.jpg');">
            </div>
            ...
            <div class="item" style="background: url('vistas/assets/images/azafatas/nuevas1023/4.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/_CP_8972.JPG');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/1.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/nuevas1023/7.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/nuevas1023/8.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/s5Gr.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/3.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/s8Gr.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/azafatas/s4Gt.jpg');">
            </div>
          </div>
