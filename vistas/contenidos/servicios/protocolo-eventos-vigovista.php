  ...
  <div class="container gris parah1sv" style="width: 100%">
    <div class="row " style="margin-top: 0px;">
      <div class="col-sm-12 creativeM" style="margin-top: 0%">
        <h1 class="grande">Gabinete de prensa y relaciones públicas</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 conten" style="padding:0px !important">
        <div class="col-md-6 altocompleto col-xs-12 imagen two">
          <div class="texto">
            <h2>Protocolo y comunicación</h2>
            <p>
              El servicio de Gabinete de Comunicación y RRPP de Absolute se encarga de planificar, coordinar y desarrollar acciones de comunicación para empresas e instituciones. Somos expertos en identificar la noticia e idear acciones comunicativas para convertir la actividad, producto, evento o acto del cliente en noticia de interés. Está integrado por expertos en comunicación, protocolo y relaciones públicas y su trabajo consiste en posicionar una marca y generar una opinión pública y una imagen de marca positiva, sirviendo de enlace entre la empresa y los medios de comunicación, influencers y otros grupos de opinión.
            </p>
          </div>
        </div>
        ...
        <div id="myCarousel" class="carousel slide col-md-6 one" data-ride="carousel">
          <div class="carousel-inner slidesvs" role="listbox">
            <div class="item active" style="background: url('vistas/assets/images/protocolo/IMG_0223.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/protocolo/IMG_8708.JPG');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/protocolo/s1Gi.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/protocolo/s2Gk.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/protocolo/s4Gp.jpg');">
            </div>
          </div>
