  ...
  <div class="container gris parah1sv" style="width: 100%">
    <div class="row " style="margin-top: 0px;">
      <div class="col-sm-12 creativeM" style="margin-top: 0%">
        <h1 class="grande">Diseño y construcción de stands</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 conten" style="padding:0px !important">
        <div class="col-md-6 altocompleto col-xs-12 imagen two">
          <div class="texto">
            <h2>Stands de diseño y modulares</h2>
            <p>
            ...
            <p>
              <br />
              <br />
              <a class="linkVideoYT" href="https://www.youtube.com/watch?v=NK1OcXrbA34" target="_blank">
                <img src="vistas/assets/images/yti.png" alt="Logo YouTube" class="yti">
              </a>
              &nbsp;&nbsp;&nbsp;
              <a class="linkVideoYT" href="https://www.youtube.com/watch?v=NK1OcXrbA34" target="_blank">Video de YouTube</a>
            </p>

            <p>
              <br>
              <a class="linkVideoYT" href="https://www.youtube.com/watch?v=fNoPHL_FPcc" target="_blank">
                <img src="vistas/assets/images/yti.png" alt="Logo YouTube" class="yti">
              </a>
              &nbsp;&nbsp;&nbsp;
              <a class="linkVideoYT" href="https://www.youtube.com/watch?v=fNoPHL_FPcc" target="_blank">Video de YouTube</a>
            </p>
          </div>
        </div>
        ...
        <div id="myCarousel" class="carousel slide col-md-6 one" data-ride="carousel">
          <div class="carousel-inner slidesvs" role="listbox">
            ...
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/15.jpg');">
            </div>
            ...
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/medimar.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/_CP_1419.JPG');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/ALAIOR.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/Cordoba2025.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/Tarragona.png');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/s4G.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/SEDNI.jpg');">
            </div>
            <div class="item" style="background: url('vistas/assets/images/diseno_Stands/asturias.jpg');">
            </div>
