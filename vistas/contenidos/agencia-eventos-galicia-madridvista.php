...
.problema{padding-top:45px !important;}
.solucion{padding-top: 45px !important;}
.secPaddingcuadro4{
...
<?php include 'vistas/modulos/serviciosEVENTSLAB.php'; ?>
    ...
    <section class="hero-caption secPaddingcuadro1 quees">
      <div class="container gris parah1" style="width: 100%">
       <div class="row " >
          <div class="col-sm-12" >
            <h1 class="grande">Agencia de eventos Galicia y Madrid</h1>
          </div>
      ...
      <div class="container gris">
       <div class="row " style="margin-top: 0px;">
          <div class="col-sm-5" style="padding-left:0px !important;padding-right:0px !important;">
              <h2 class="grande izda problema">Eventos que<br />hacen sentir<br />algo único</h2>
            </div>
            <div class="col-sm-7">
              <p style="text-align: justify;font-size:14px;padding-bottom: 37px !important;" class="irresistible saltogris solucion">
      ...
      <section class="hero-caption secPaddingcuadro4 ">
        <div class="container" style="width: 100%">
          <div class="col-sm-12" style="padding-left:30px !important;padding-right:0px !important;">
            <h2 class="grande subra" style="text-align: center;padding-bottom: 0px;">ASÍ CREAMOS EVENTOS INOLVIDABLES</h2>
          </div>
          <img src="vistas/assets/images/eventos/infografia/eventos.jpg" style="display: block;padding-top: 55px;" alt="Agencia de Eventos en Vigo y Madrid" class="mapaimagen" usemap="#map" id="imagencambiante">
    ...
    <div class="panel-heading" id="headingOne">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          <img src="vistas/assets/images/eventos/infografia/reunion-previa.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="reunión previa" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingTwo">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <img src="vistas/assets/images/eventos/infografia/conceptualizacion-propuesta.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="conceptualización de propuestas" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingThree">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <img src="vistas/assets/images/eventos/infografia/localizacion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="localización" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingFour">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
          <img src="vistas/assets/images/eventos/infografia/direccion-arte.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="Dirección de arte" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingFive">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
          <img src="vistas/assets/images/eventos/infografia/produccion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="Producción" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingSix">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
          <img src="vistas/assets/images/eventos/infografia/ejecucion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="Ejecución" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingSeven">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
          <img src="vistas/assets/images/eventos/infografia/comunicacion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="Comnunicación" class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div class="panel-heading" id="headingEigth">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseEigth" aria-expanded="false" aria-controls="collapseEigth">
          <img src="vistas/assets/images/eventos/infografia/analitica-informes.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="Analitica e informes" class="img-fluid">
        </button>
      </h2>
    </div>
...
<section class="hero-caption secPaddingcuadro5 thinkingTEXTOIMAGEN">
  <div class="container">
   <div class="row " style="margin-top: 0px;">
