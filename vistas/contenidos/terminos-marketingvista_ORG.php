...
<!-- banner start -->
<div class="bannerE">
<img src="vistas/assets/images/banner-diccionario-marketing.png" alt="banner-marketing" style="
  width: 100%;
  height: auto;
  padding-top: 85px;">
  ...
  <div class="banner-caption">
    <div class="container">
     <div class="row " style="margin-top: 0px;">
        ...
        <div class="col-sm-6">
<img src="vistas/assets/images/PLANBPLUS.png" class="imgcreative">
        </div>

        <div class="col-sm-6">
    <!-- <h2>welcome to <strong>AVENGER</strong> - <span>*</span> * </h2> -->
    <img src="vistas/assets/images/absolute_blanco.png" class="imgcreative">
        </div>
...
<!-- section start -->
<section class="section clearfix no-view secPaddingcuadro1" data-animation-effect="fadeIn" style="padding-top: 130px;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="vistas/assets/images/section-image-1.png" alt="">
            <div class="space"></div>
          </div>
          <div class="col-md-6">
