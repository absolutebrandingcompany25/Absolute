...
<?php include 'vistas/modulos/serviciosDIGITALLAB.php'; ?>
    ...
    <div class="col-sm-6 planb secPaddingcuadro1" style="padding:0px;background-color: white;max-height: 485px;box-shadow: #000000a6 11px 0px 13px 3px !important;overflow: hidden;">
      ...
      <section class="hero-caption secPaddingcuadro3 " style="padding-bottom:100px;">
        <div class="container" style="width: 100%">
          ...
          <img src="vistas/assets/images/digital/digital.jpg" style="display: block;padding-top: 10px;" alt="marketing con..." class="mapaimagen" usemap="#map" id="imagencambiante">
    ...
    <div class="panel-heading" id="headingOne">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          <img src="vistas/assets/images/digital/trafico.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        </button>
      </h2>
    </div>
    ...
    <div id="collapseOne" class="panel-collapse collapse"aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="panel-body">
        ...
        <img src="vistas/assets/images/digital/blogging.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/seo.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/publicidad.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/video.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    <div class="panel-heading" id="headingTwo">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <img src="vistas/assets/images/digital/adquisicion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        </button>
      </h2>
    </div>
    <div id="collapseTwo" class="panel-collapse collapse"aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="panel-body">
        ...
        <img src="vistas/assets/images/digital/ofertas.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/landing.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/call-to-action.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/social-media.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    <div class="panel-heading" id="headingThree">
      <h2 class="panel-title">
        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          <img src="vistas/assets/images/digital/conversion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        </button>
      </h2>
    </div>
    <div id="collapseThree" class="panel-collapse collapse"aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="panel-body">
        ...
        <img src="vistas/assets/images/digital/email.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/leads.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/analisis-resultados.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
        <img src="vistas/assets/images/digital/social-crm.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="marketing con..." class="img-fluid">
      </div>
    </div>
  </div>
          </div>
