...
<section class="hero-caption secPaddingcuadro2" style="padding: 0;">
  ...
  <!-- Carousel End -->
    ...
    <section class="secPaddingcuadro3" style="padding-top: 0px;" id="circulo">
      <img src="vistas/assets/images/nosotros/nosotros.jpg" class="infografia mapaimagen" alt="ayudamos a vender" usemap="#map" id="imagencambiante">
              ...
              <div class="panel-heading" id="headingOne">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <img src="vistas/assets/images/nosotros/movil/acciones.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="acciones" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseOne" class="panel-collapse collapse"aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/acciones-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="acciones" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingTwo">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    <img src="vistas/assets/images/nosotros/movil/auditoria.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="auditoria" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseTwo" class="panel-collapse collapse"aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/auditoria-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="auditoria" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingThree">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <img src="vistas/assets/images/nosotros/movil/creatividad.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="creatividad" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseThree" class="panel-collapse collapse"aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/creatividad-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="creatividad" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingFour">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <img src="vistas/assets/images/nosotros/movil/ejecucion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="ejecucion" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseFour" class="panel-collapse collapse"aria-labelledby="headingFour" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/ejecucion-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="ejecucion" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingFive">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                    <img src="vistas/assets/images/nosotros/movil/estrategias.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="estrategias" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseFive" class="panel-collapse collapse"aria-labelledby="headingFive" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/estrategias-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="estrategias" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingSix">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                    <img src="vistas/assets/images/nosotros/movil/evaluacion.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="evaluacion" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseSix" class="panel-collapse collapse"aria-labelledby="headingSix" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/evaluacion-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="evaluacion" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingSeven">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                    <img src="vistas/assets/images/nosotros/movil/indicadores.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="indicadores" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseSeven" class="panel-collapse collapse"aria-labelledby="headingSeven" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/indicadores-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="indicadores" class="img-fluid">
                </div>
              </div>
            </div>
              ...
              <div class="panel-heading" id="headingEight">
                <h2 class="panel-title">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                    <img src="vistas/assets/images/nosotros/movil/objetivos.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="objetivos" class="img-fluid">
                  </button>
                </h2>
              </div>
              <div id="collapseEight" class="panel-collapse collapse"aria-labelledby="headingEight" data-parent="#accordionExample">
                <div class="panel-body">
                  <img src="vistas/assets/images/nosotros/movil/objetivos-interna.png" style="display: block;padding-top: 10px; margin: 0 auto;" alt="objetivos" class="img-fluid">
                </div>
              </div>
            </div>
